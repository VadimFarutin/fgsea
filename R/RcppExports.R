...
calcGseaStatCumulativeBatch <- function(stats, geneToGroup, groupEnds, gseaParam, pathwayScores, pathwaysSizes, iterations, seed) {
    .Call('_fgsea_calcGseaStatCumulativeBatch', PACKAGE = 'fgsea', stats, geneToGroup, groupEnds, gseaParam, pathwayScores, pathwaysSizes, iterations, seed)
}

calcGseaStatCumulative <- function(stats, selectedStats, gseaParam, geneToGroup, groupEnds) {
    .Call('_fgsea_calcGseaStatCumulative', PACKAGE = 'fgsea', stats, selectedStats, gseaParam, geneToGroup, groupEnds)
}
